...
function confMenu () {
	...
	if (arguments[0]) {
		...
		menuBar[0].addEvents ({
			'mouseenter': function () {menuBar[0].setStyle('background-position', '-300px top')},
			'mouseleave': function () {menuBar[0].setStyle('background-position', '-150px top')},
			'mousedown': function(){
					initAct();
				}
		});
	...
	if (arguments[1]) {
		...
		menuBar[1].addEvents ({
			'mouseenter': function () {menuBar[1].setStyle('background-position', '-300px top')},
			'mouseleave': function () {menuBar[1].setStyle('background-position', '-150px top')},
			'mousedown': function(){checkAct()}
		});
	};
	...
	if (arguments[2]) {
		...
		menuBar[2].addEvents ({
			'mouseenter': function () {menuBar[2].setStyle('background-position', '-300px top')},
			'mouseleave': function () {menuBar[2].setStyle('background-position', '-150px top')},
			'mousedown': function(){
	...
	if (arguments[3]) {
		...
		menuBar[3].addEvents ({
			'mouseenter': function () {menuBar[3].setStyle('background-position', '-300px top')},
			'mouseleave': function () {menuBar[3].setStyle('background-position', '-150px top')},
			'mousedown': function(){
				var link = (document.location).toString ();
				var arrlink = link.split ('/');
	...
	if (arguments[4]) {
		...
		menuBar[4].addEvents ({
			'mouseenter': function () {menuBar[4].setStyle('background-position', '-300px top')},
			'mouseleave': function () {menuBar[4].setStyle('background-position', '-150px top')},
			'mousedown': function(){
				var link = (document.location).toString ();
				var arrlink = link.split ('/');
				var letraNext = String.fromCharCode (arrlink[arrlink.length-1].charCodeAt(5) + 1);
