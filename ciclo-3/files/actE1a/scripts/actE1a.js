...
//		if (iTapa < (pareja.length / 2)) console.log (tapas[fchs[iTapa]]);
		...
		tapa.addEvents ({
			'mousedown': function (e) {
				...
				if (ordFch == 2) {
					...
					$$('#desk div span')[idTapaUno].setStyle ('color', colores[pareja[idTapaUno]]);
					$$('#desk div span')[iTapa].setStyle ('color', colores[pareja[iTapa]]);
