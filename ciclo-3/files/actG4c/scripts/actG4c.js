...
//				frase = frase + drag.getText();
	...
	/* objeto actG4c tipo DxD.Base  */
	var actG4c = new DxD.Base (forDrags, toDrops, {
		container: $('content'),
		sendToBack: 'ini',
	...
	actG4c.fncTrueDrop = function (drag, drop) {
...
// function initAct() de miDxD
	initAct2 = function () {
		...
		actG4c.reset();
		actG4c.drags.each (function (drag, iD){
...
}); // end onDomReady// function initAct() de 
